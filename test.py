...
from day import dayforA
from atten import studAtten
from sub import subwise
...
def clicked():
    ...
    if txt1.get()=="varun" and txt2.get()=="varun":
        flag=0
        for item in list:
            if item==txt3.get():
                day=item
        ...
        if flag==1:
            ...
            def fixed1():#student login
                ...
                f1=StringVar
                roll=Entry(student,width=30,textvariable=f1)
               ...
               # v.set("a default value")
                def show_attendence():
                    ...
                    studAtten(f1)
                    student.destroy()
                rollbutton=Button(student,text="Show Attendance",relief=RAISED,bg="grey",fg="black",font="Helvetica 8 bold",command=show_attendence)
            ...
            def fixed2():#teacher login
                ...
                f2=StringVar
                rol=Entry(teacher,width=30,textvariable=f2)
                ...
                def show():
                    ...
                    subwise(f2)
                    teacher.destroy()
                tbutton=Button(teacher,text="Show ",relief=RAISED,bg="grey",fg="black",font="Helvetica 8 bold",command=show)
               # rollbutton.place(x=250,y=200,anchor="center")
